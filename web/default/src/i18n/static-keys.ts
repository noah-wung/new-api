...
export const STATIC_I18N_KEYS = [
  ...
  'Model usage summary',
  'Review one user across gateway and external usage sources.',
  'Select a user',
  'Search for a user or click a bar in the user ranking.',
  'Token usage',
  'Raw tokens across every filtered model',
  'Gateway billing consumption',
  'Gateway requests',
  'Requests handled by the gateway',
  'External events',
  'Usage events reported by external tools',
  'Failed to load model usage',
  'An unexpected server error occurred.',
  'Dashboard aggregation is disabled',
  'New dashboard aggregates are not being collected.',
  'Consume-log collection is disabled',
  'New gateway request usage may be missing from this summary.',
  'External usage collection is disabled',
  'Historical external usage remains visible in this summary.',
  'Models and sources',
  'Refreshing model usage…',
  'Cached for 60 seconds. Server aggregates refresh every {{minutes}} minutes.',
  'Filter by literal model name',
  'Select sources',
  ...
  'No usage records',
  'Clear the filters to review all model usage.',
